...
public struct Parser {
  ...
  private static func apply(_ continuation: Statement? = nil,
  ...
  private static func block(_ state: inout ParserState) -> Statement? {
    guard state.diagnostics.empty else { return nil }
    ...
    return BlockStatement(statements: statements, range: range)
  }
  ...
  private static func statement(_ state: inout ParserState) -> Statement? {
  ...
  private static func condition(_ state: inout ParserState) -> Statement? {
    nil
  }

  public static func parse(_ input: SourceFile,
                           into statements: inout [Statement],
                           diagnostics: inout DiagnosticSet) throws {
    var state: ParserState =
        ParserState(lexing: input, into: statements, diagnostics: diagnostics)
